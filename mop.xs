...
BOOT:
{
    ...
    CV *intro_twigil_state_var_cv = get_cv("mop::internals::twigils::intro_twigil_state_var", 0);
    CV *intro_twigil_our_var_cv = get_cv("mop::internals::twigils::intro_twigil_our_var", 0);
