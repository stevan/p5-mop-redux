...
ok(Comparable->metaclass->does_role( 'Eq' ), '... Comparable does the Eq role');

ok(US::Currency->metaclass->does_role( 'Eq' ), '... US::Currency does Eq');
ok(US::Currency->metaclass->does_role( 'Comparable' ), '... US::Currency does Comparable');
ok(US::Currency->metaclass->does_role( 'Printable' ), '... US::Currency does Printable');

ok(Eq->metaclass->requires_method('equal_to'), '... EQ::equal_to is a stub method');
ok(!Eq->metaclass->requires_method('not_equal_to'), '... EQ::not_equal_to is NOT a stub method');
